...
<head>
    ...
    {{-- DataTables --}}
    <link rel="stylesheet" type="text/css" href="{{ asset('css/cdn.datatables.net_1.11.2_css_jquery.dataTables.min.css') }}">
...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                  ...
                  <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
                      <g id="Icon" transform="translate(27.000000, 15.000000)">
                        ...
                        <span class="app-brand-text demo menu-text fw-bolder ms-0">Shoplinep</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item {{ request()->is('seller/products') ? 'active' : '' }}">
                        <a href="/seller/products" class="menu-link">
                    ...
                    <li class="menu-item">
                        <a href="/seller/sales" class="menu-link">
        ...
        <script src="{{ asset('js/cdn.datatables.net_1.11.2_js_jquery.dataTables.min.js') }}"></script>
        <script>
